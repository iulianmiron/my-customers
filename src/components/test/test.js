(function() {
	...
	angular
		...
		testController.$inject = ['$timeout', 'ClientsDataService', 'HistoryDataService'];
		function testController($timeout, ClientsDataService, HistoryDataService) {
			var ctrl = this;
			ctrl.data = {};
			ctrl.status = {};
			ctrl.actions = {};
			...
			ctrl.$onInit = function() {
				...
				// getAllClients();
				ctrl.data.date = {};
				ctrl.actions.searchByDate = searchByDate;
				
			}

			
			function searchByDate(date) {
				HistoryDataService.getByDateRange(date).then(function(rHistory) {
					console.log('history', rHistory);
				});
			}
